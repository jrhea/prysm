...
func (x *Status) GetFinalizedEpoch() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
...
func (x *Status) GetHeadSlot() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Slot {
	if x != nil {
		return x.HeadSlot
	}
...
func (x *ENRForkID) GetNextForkEpoch() github_com_OffchainLabs_prysm_v6_consensus_types_primitives.Epoch {
	if x != nil {
